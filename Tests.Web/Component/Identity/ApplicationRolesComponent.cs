...
{
    public class ApplicationRolesComponent : ComponentBase
    {
        ...
        {
            var dialogResult = await DialogService.OpenAsync<AddApplicationRoleComponent>("Add Application Role", null);
            await Load();
